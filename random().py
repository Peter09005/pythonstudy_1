...
print(randint(1,45)); # 이렇게 해주주면 1부터 45, randrange함수는 1부터 n-1까지였지만 randint 함수를 통해서 좀 더 수월하게 할수있다.


#실습1 from random inport *

date = randrange(3,29); # 3일부터 29-1 일까지
print('오프라인 스터디 모임 날짜는 매월' + str(date) + '일로 선정되었습니다');

# 형변환은 타입(값) 이렇게 해준다. Java와는 다르게 string과 합쳐주려면 형변환이 필요하다.
